...
/*
 * This class is default controller.
 */
public class Controller {
	...
	protected void switchScene(final ViewEnum p, ActionEvent event, String username) throws IOException {
		...
		controller.setUsernameLb(username); // Use this to set the username to view. Note that you should set it to
											// database or model or somewhere else.
